...
const getBadge = (type) => {
  // Görseldeki mantığı koruyup renkleri daha canlı hale getirdik
  const styles = {
    login: { bg: "rgba(239, 68, 68, 0.1)", color: "#ef4444", text: "Giriş" },
    update: { bg: "rgba(239, 68, 68, 0.1)", color: "#ef4444", text: "Güncelleme" },
    create: { bg: "rgba(239, 68, 68, 0.1)", color: "#ef4444", text: "Oluşturma" },
    warning: { bg: "rgba(245, 158, 11, 0.1)", color: "#f59e0b", text: "Kritik" },
    delete: { bg: "rgba(239, 68, 68, 0.1)", color: "#ef4444", text: "Silme" },
  };
  const style = styles[type] || { bg: "#f3f4f6", color: "#6b7280", text: "İşlem" };

  return (
    <span className="badge rounded-pill border-0" 
      style={{ 
