...
const TaskCreateContent = () => {
  ...
  useEffect(() => {
    ...
    projectService
      ...
      .then((res) => setProjects(res?.data?.data ?? res?.data?.items ?? []))
      .catch(() => setProjects([]));
  }, []);
  ...
  const onSubmit = async () => {
    ...
    try {
      const payload = {
        ...form,
        // boş stringleri null'a çevirelim ki backend daha temiz alsın
        customerId: form.customerId || undefined,
        projectId: form.projectId || undefined, // ✅ EKLENDİ
