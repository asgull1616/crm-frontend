...
const OtpVerifyForm = () => {
    return (
        <>
            <h2 className="fs-20 fw-bolder mb-4">Verify <a href="#" className="float-end fs-12 text-primary">Yöntemi değiştir  </a></h2>
            <h4 className="fs-13 fw-bold mb-2">Lütfen size gönderilen tek kullanımlık şifreyi girin .</h4>
            <p className="fs-12 fw-medium text-muted"><span>Kod şuraya gönderildi. </span> <strong>*******9897</strong></p>
            <form action="" className="w-100 mt-4 pt-2">
                ...
                <div className="mt-5">
                    <button type="submit" className="btn btn-lg btn-primary w-100">Doğrula</button>
                </div>
                <div className="mt-5 text-muted">
                    <span>Kodu almadınız mı ? </span>
                    <a href="#">Tekrar gönder(1/3)</a>
                </div>
            </form>
        </>
    )
